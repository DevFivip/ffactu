    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <!-- <div class="card-header">
                    <div>
                        <h4 class="card-title">Consulta de inventarios asd</h4>
                    </div>
                </div> -->
            <div class="card-body">
                <div>
                        ...
                        <div style="margin-bottom: 10px" class="row">
                            ...
                            <div class="col-md-4">
                                <form action="{{route('reports.inventory.pdf')}}" class="d-inline" method="POST">
                                    ...
                                    <button class="button is-primary" type="submit"><i class="fa fa-file-pdf"></i>&nbsp; Exportar PDF</button>
                                ...
                                <form action="{{route('reports.inventory.report_excel')}}" class="d-inline" method="POST">
                                    {{csrf_field()}}
                                    <input type="hidden" name="warehouse_id" value="{{request()->warehouse_id ? request()->warehouse_id : 'all'}}">
                                    <button class="button is-primary" type="submit"><i class="fa fa-file-excel"></i>&nbsp; Exportar Excel</button>
                                    {{-- <label class="pull-right">Se encontraron {{$reports->count()}} registros.</label> --}}
                                </form>
                            </div>
