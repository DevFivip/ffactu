    ...
    <div>
        ...
        <!-- <div class="page-header pr-0">
            ...
            <ol class="breadcrumbs">
                <li class="active"><span>{{ title }} asdasd</span></li>
            </ol>
        </div> -->

        <div class="card p-5" v-loading="loading">
            ...
            <div class="card-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label>Periodo</label>
                        <el-date-picker v-model="form.month" type="month" value-format="yyyy-MM" format="MM/yyyy"
