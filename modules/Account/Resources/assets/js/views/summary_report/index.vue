                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-3">
                        <div class="form-group" :class="{ 'has-danger': errors.date_start }">
                            ...
                            <small class="form-control-feedback" v-if="errors.date_start"
                    ...
                    <div class="col-md-6" style="margin-top:29px">
                        ...
                        <template v-if="accepted_documents.length > 0">
                            ...
                            <el-button class="submit" type="success" @click.prevent="clickDownload('excel')"><i
                                    class="fa fa-file-excel"></i> Exportal Excel</el-button>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            {{ totals_accepted_documents.general_total_plastic_bag_taxes }}</td>
