                ...
                <data-table :resource="resource">
                    ...
                    <tr slot-scope="{ index, row }">
                        ...
                        <td>
                            ...
                            <el-popover placement="right" width="400" trigger="click">
                                <el-table :data="row.items">
                                    ...
                                    <el-table-column width="220" property="description" label="Nombre">
                                    </el-table-column>
                        ...
                        <td>
                            ...
                            <a v-if="row.state_type_id != '11'" :href="`/${resource}/create/${row.id}`" type="button"
                                class="btn waves-effect waves-light btn-xs btn-info">Editar</a>
                            <button v-if="row.state_type_id != '11'" type="button"
                                class="btn waves-effect waves-light btn-xs btn-danger"
                                @click.prevent="clickVoided(row.id)">Anular</button>
                            <button v-if="row.state_type_id == '11'" type="button"
                                class="btn waves-effect waves-light btn-xs btn-danger"
