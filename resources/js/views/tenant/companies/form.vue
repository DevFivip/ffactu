                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" :class="{ 'has-danger': errors.trade_name }">
                                    <label class="control-label">Nombre comercial <span
                                            class="text-danger">*</span></label>
                                    <el-input v-model="form.trade_name"></el-input>
                                    <small class="form-control-feedback" v-if="errors.trade_name"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <el-input v-model="form.logo" :readonly="true">
                                        <el-upload slot="append" :headers="headers" :data="{ 'type': 'logo' }"
                                            action="/companies/uploads" :show-file-list="false"
                            ...
                            <div class="col-md-6">
                                <div class="form-group" :class="{ 'has-danger': errors.detraction_account }">
                                    ...
                                    <small class="form-control-feedback" v-if="errors.detraction_account"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <el-input v-model="form.img_firm" :readonly="true">
                                        <el-upload slot="append" :headers="headers" :data="{ 'type': 'img_firm' }"
                                            action="/companies/uploads" :show-file-list="false"
                                            :on-success="successUpload">
                                            <el-button type="primary" icon="el-icon-upload"></el-button>
                                        </el-upload>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <el-input v-model="form.favicon" :readonly="true">
                                        <el-upload slot="append" :headers="headers" :data="{ 'type': 'favicon' }"
                                            action="/companies/uploads" :show-file-list="false"
                                            :on-success="successUpload">
                                            <el-button type="primary" icon="el-icon-upload"></el-button>
                                        </el-upload>
                                    ...
                                    <div class="sub-title text-danger"><small>Se recomienda una imagen con fondo
                                            transparente y cuadrada en formato PNG</small></div>
                                </div>
                            </div>
                            <div class="col-md-6" v-if="form.soap_type_id == '02'">
                                <div class="form-group" :class="{ 'has-danger': errors.certificate_due }">
                                    ...
                                    <el-date-picker v-model="form.certificate_due" type="date" value-format="yyyy-MM-dd"
                                        :clearable="true"></el-date-picker>
                                    <small class="form-control-feedback" v-if="errors.certificate_due"
                            ...
                            <div class="col-md-6">
                                <div class="form-group" :class="{ 'has-danger': errors.soap_type_id }">
                                    ...
                                    <el-select :disabled="!form.config_system_env" v-model="form.soap_type_id">
                                        <el-option v-for="option in soap_types" :key="option.id" :value="option.id"
                                    ...
                                    <small class="form-control-feedback" v-if="errors.soap_type_id"
                            ...
                            <div class="col-md-6" v-if="form.soap_type_id != '03'">
                                <div class="form-group" :class="{ 'has-danger': errors.soap_send_id }">
                                    ...
                                    <el-select :disabled="!form.config_system_env" v-model="form.soap_send_id">
                                        <el-option v-for="(option, index) in soap_sends" :key="index" :value="index"
                                            :label="option"></el-option>
                                    </el-select>
                                    <small class="form-control-feedback" v-if="errors.soap_send_id"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" :class="{ 'has-danger': errors.soap_username }">
                                        <label class="control-label">SOAP Usuario <span
                                                class="text-danger">*</span></label>
                                        <el-input :disabled="!form.config_system_env" v-model="form.soap_username">
                                        </el-input>
                                        <div class="sub-title text-muted"><small>RUC + Usuario. Ejemplo:
                                                01234567890ELUSUARIO</small></div>
                                        <small class="form-control-feedback" v-if="errors.soap_username"
                                            v-text="errors.soap_username[0]"></small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group" :class="{ 'has-danger': errors.soap_password }">
                                        <label class="control-label">SOAP Password <span
                                                class="text-danger">*</span></label>
                                        <el-input :disabled="!form.config_system_env" v-model="form.soap_password">
                                        </el-input>
                                        <small class="form-control-feedback" v-if="errors.soap_password"
                        ...
                        <div class="row" v-if="form.soap_send_id == '02'">
                            <div class="col-md-12">
                                <div class="form-group" :class="{ 'has-danger': errors.soap_url }">
                                    ...
                                    <small class="form-control-feedback" v-if="errors.soap_url"
