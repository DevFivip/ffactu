<template>
    <div class="card">
        ...
        <div class="card-content">
            <span class="title">Consistencia de documentos</span>
            <template>
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column v-if="columns.accepted.visible" label="Aceptados" prop="accepted">
                    </el-table-column>
                    <el-table-column v-if="columns.observed.visible" label="Observados" prop="observed">
                    </el-table-column>
                    <el-table-column v-if="columns.rejected.visible" label="Rechazados" prop="rejected">
                    </el-table-column>
                    <el-table-column v-if="columns.canceled.visible" label="Anulados" prop="canceled"></el-table-column>
                    <el-table-column v-if="columns.byVoiding.visible" label="Por anular" prop="byVoiding">
                    </el-table-column>
                </el-table>
            </template>
        </div>
        <tenant-tasks-form :showDialog.sync="showDialog" :tableData.sync="tableData" @refresh="refresh">
        </tenant-tasks-form>
    </div>
</template>
