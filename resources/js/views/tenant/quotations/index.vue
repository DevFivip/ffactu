<template>
    <div>
        ...
        <section class="hero is-primary is-rounded">
            <div class="hero-body">
                <p class="title">
                    Cotizaciones {{soapCompany}}
                </p>
                <div class="buttons">
                    <a class="button is-success" :href="`/${resource}/create`">Nuevo</a>
                </div>
            </div>
        </section>
        ...
        <div class="card mb-0">
                    ...
                    <tr slot-scope="{ index, row }" :class="{ anulate_color: row.state_type_id == '11' }">
                        ...
                        <td class="text-right">
                            <button
                                ...
                                type="button" class="btn waves-effect waves-light btn-xs btn-info"
                            ...
                            <button @click="duplicate(row.id)" type="button"
                                class="btn waves-effect waves-light btn-xs btn-info">Duplicar</button>
                            ...
                            <template v-else>
                                <button type="button" @click="clickPrintContract(row.external_id_contract)"
                                    class="btn waves-effect waves-light btn-xs btn-primary m-1__2">Ver contrato</button>
                            </template>
            ...
            <quotation-options :showDialog.sync="showDialogOptions" :recordId="recordId" :showGenerate="true"
                :showClose="true"></quotation-options>

            <quotation-options-pdf :showDialog.sync="showDialogOptionsPdf" :recordId="recordId" :showClose="true">
            </quotation-options-pdf>


            <quotation-payments :showDialog.sync="showDialogPayments" :recordId="recordId"></quotation-payments>
        </div>
    </div>
</template>
<style scoped>
