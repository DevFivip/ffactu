<template>
    <div class="card">
        ...
        <div class="card-content" v-if="loading_form">
            <div class="invoice">
                <header class="clearfix">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <el-checkbox v-model="is_contingency" @change="changeEstablishment">¿Es comprobante de
                            ...
                            <template v-if="!is_client">
                                ...
                                <el-checkbox v-model="form.has_prepayment" v-if="!prepayment_deduction"
                                    @change="changeHasPrepayment" class="full">¿Es un pago anticipado?</el-checkbox>
                                <el-checkbox v-model="prepayment_deduction" @change="changePrepaymentDeduction"
                                    v-if="!form.has_prepayment" class="full">Deducción de los pagos anticipados
                                </el-checkbox>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <el-select v-if="form.has_prepayment || prepayment_deduction"
                                            ...
                                            @change="changeAffectationTypePrepayment"
                                            class="border-left rounded-left border-info mb-2">
                ...
                <form autocomplete="off" @submit.prevent="submit">
                        ...
                        <div class="row mt-1">
                            ...
                            <div v-if="typeUser == 'admin'" class="col-lg-2">
                                <div class="form-group">
                                    ...
                                    <el-select v-model="form.seller_id">
                                        <el-option v-for="option in sellers" :key="option.id" :value="option.id"
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{ 'has-danger': errors.date_of_issue }">
                                    ...
                                    <el-date-picker v-model="form.date_of_issue" type="date" value-format="yyyy-MM-dd"
                                        :clearable="false" @change="changeDateOfIssue" :picker-options="datEmision"
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{ 'has-danger': errors.date_of_due }">
                                    ...
                                    <el-date-picker v-model="form.date_of_due" type="date" value-format="yyyy-MM-dd"
                                        :clearable="false" :readonly="readonly_date_of_due"></el-date-picker>
                            ...
                            <template v-if="!is_client">
                                <div class="col-lg-2 mt-2 mb-2" v-if="form.document_type_id == '03'">
                                    <div class="form-group">
                                        <el-checkbox v-model="is_receivable" class=" font-weight-bold"
                                            @change="changeIsReceivable">¿Es venta por cobrar?</el-checkbox>
                                    </div>
                                </div>
                            </template>
                        </div>
                                        ...
                                        <tr width="100%">
                                            ...
                                            <template v-if="enabled_payments">
                                                <th v-if="form.payments.length > 0" class="pb-2">
                                                    <b-tooltip label="Aperture caja o cuentas bancarias"
                                                        position="is-bottom">
                                                        <span class="is-underlined">Destino</span>
                                                    </b-tooltip>
                                                </th>
                                                ...
                                                <th width="15%">
                                                    <b-button type="is-primary" size="is-small"
                                                        @click.prevent="clickAddPayment">Agregar</b-button>
                                                </th>
                                            </template>
                                        </tr>
                                    </thead>
                                            ...
                                            <template v-if="!isActiveBussinessTurn('tap')">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group"
                                                        ...
                                                        <el-input type="textarea" v-model="form.purchase_order">
                                                        </el-input>
                                ...
                                <table>
                                    <tr v-if="form.total_taxed > 0 && enabled_discount_global">
                                        <td>
                                            ...
                                            <el-checkbox class="ml-1 mr-1" v-model="is_amount"
                                                @change="changeTypeDiscount"></el-checkbox>

                                        </td>
                                        <td>:</td>
                                        <td class="text-right">
                                            <el-input class="input-custom" v-model="total_global_discount"
                                    ...
                                    <tr v-if="form.detraction.amount > 0">
                                        <td>M. DETRACCIÓN</td>
                                        <td>:</td>
                                        <td class="text-right">{{ currency_type.symbol }} {{ form.detraction.amount }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr v-if="form.total_exportation > 0">
                                        ...
                                        <td>:</td>
                                        <td class="text-right">{{ currency_type.symbol }} {{ form.total_exportation }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr v-if="form.total_unaffected > 0">
                                        <td>OP.INAFECTAS</td>
                                        <td>:</td>
                                        <td class="text-right">{{ currency_type.symbol }} {{ form.total_unaffected }}
                                        </td>
                                    </tr>
                                    <tr v-if="form.total_exonerated > 0">
                                        <td>OP.EXONERADAS</td>
                                        <td>:</td>
                                        <td class="text-right">{{ currency_type.symbol }} {{ form.total_exonerated }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr v-if="form.total_prepayment > 0">
                                        <td>ANTICIPOS</td>
                                        <td>:</td>
                                        <td class="text-right">{{ currency_type.symbol }} {{ form.total_prepayment }}
                                        </td>
                                    </tr>
                    ...
                    <div class="form-actions text-right mt-4">
                        ...
                        <el-button class="submit" type="primary" native-type="submit" :loading="loading_submit"
                            v-if="form.items.length > 0 && this.dateValid">Generar</el-button>
                    </div>
                </form>
            </div>
            ...
            <document-form-item :showDialog.sync="showDialogAddItem" :recordItem="recordItem" :isEditItemNote="false"
                ...
                :editNameProduct="configuration.edit_name_product" @add="addRow"></document-form-item>
            ...
            <document-options :showDialog.sync="showDialogOptions" :recordId="documentNewId"
                :isContingency="is_contingency" :showClose="false"></document-options>


            <document-hotel-form :showDialog.sync="showDialogFormHotel" :hotel="form.hotel"
            ...
            <document-detraction :detraction="form.detraction" :total="form.total"
                :operation-type-id="form.operation_type_id" :currency-type-id-active="form.currency_type_id"
                :exchange-rate-sale="form.exchange_rate_sale" :showDialog.sync="showDialogDocumentDetraction"
