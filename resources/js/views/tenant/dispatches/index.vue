<template>
    <div>
            ...
            <div class="card-body">
                <data-table :resource="resource">
                    ...
                    <tr slot-scope="{ index, row }" :class="{ 'text-danger': (row.state_type_id === '11') }">
                        ...
                        <td class="text-center">
                            <button v-if="!row.document_id" type="button"
        ...
        <dispatch-options :showDialog.sync="showDialogOptions" :recordId="recordId" :showClose="true">
        </dispatch-options>

        <FormGenerateDocument :showDialog.sync="showDialogGenerateDocument" :recordId="recordId" :showClose="true"
            :showGenerate="true"></FormGenerateDocument>
    </div>
</template>
