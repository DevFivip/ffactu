    ...
    <div>
        ...
        <section class="hero is-primary is-rounded">
            <div class="hero-body">
                ...
                <div class="buttons">
                    <b-button @click.prevent="clickCreate()" type="is-white">Nuevo</b-button>
                    <b-dropdown aria-role="list">
                        <template #trigger="{ active }">
                            <b-button label="Importar" type="is-primary" inverted outlined
                                :icon-right="active ? 'menu-up' : 'menu-down'" />
                        </template>
                        <a class="dropdown-item text-1" href="#" @click.prevent="clickImportSet()">Productos compuestos</a>
                        <a class="dropdown-item text-1" href="#" @click.prevent="clickImportSetIndividual()">Detalle productos compuestos</a>
                    </b-dropdown>
