    ...
    <div>
        ...
        <section class="hero is-primary is-rounded">
            <div class="hero-body">
                ...
                <p class="subtitle">
                    Plantilla PDF Guia de Remisión
                </p>
                <p class="buttons">
        ...
        <div class="card">
            ...
            <div class="card-content pt-0 pb-5">
                ...
                <span>
                    <p class="title">Seleccione plantilla de impresión de guia de remisión</p>
                    ...
                    <div v-for="(o, index) in formatos" class="col-md-3 my-2">
                        <el-card :body-style="{ padding: '0px' }" :id="o.formats">
                            <a @click="viewImage(o.formats)"><img
                                    :src="path.origin + '/templates/pdf/' + o.formats + '/image_guide.png'" class="image"
                                    style="width: 100%"></a>
