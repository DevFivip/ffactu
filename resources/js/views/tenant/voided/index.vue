    ...
    <div>
        <section class="hero is-primary is-rounded">
            <div class="hero-body">
                ...
                <div class="buttons">
                    <b-button @click.prevent="consultVoided()" :loading="loading_submit_voided">Consultar Documentos</b-button>
                </div>
                <!-- <div class="right-wrapper pull-right">
                    <form autocomplete="off" @submit.prevent="consultVoided">
                        <el-button class="btn btn-custom btn-sm  mt-2 mr-2" native-type="submit"
                            :loading="loading_submit_voided">Consultar documentos</el-button>
                    </form>
                </div> -->
