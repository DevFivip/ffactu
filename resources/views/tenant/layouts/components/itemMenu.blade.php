<a class="{{ $visible ?'shadow-soft-xl bg-white font-semibold':'' }} py-1 text-size-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4  text-slate-700 transition-colors" href="{{$url}}">
